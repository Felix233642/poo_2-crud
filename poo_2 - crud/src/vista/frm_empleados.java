 ...
 */
    ...
    txt_direccion1.setText(tbl_empleado.getValueAt(fila, 4).toString());
    ...
    private void btn_agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregarActionPerformed
        ...
        empleado = new empleados(txt_codigo.getText(),0,Integer.parseInt(id_puesto.substring(0, posc)),txt_nombre1.getText(),txt_apellido1.getText(),txt_direccion1.getText(),txt_telefono1.getText(),txt_fna.getText());
        empleado.agregar();
        tbl_empleado.setModel(empleado.leer());
        limpiar_datos();
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        empleado = new empleados(txt_codigo.getText(),Integer.parseInt(lbl_id.getText()),Integer.parseInt(id_puesto.substring(0, posc)),txt_nombre1.getText(),txt_apellido1.getText(),txt_direccion1.getText(),txt_telefono1.getText(),txt_fna.getText());
        empleado.actualizar();
        tbl_empleado.setModel(empleado.leer());
        limpiar_datos();
